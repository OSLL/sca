...
const int MAX_NODE_HEIGHT = MAX_NODE_WIDTH;
...
const QColor DEFAULT_GROUP_COLOR(51, 255, 0);
const QColor FILTERED_GROUP_COLOR(Qt::red);
const int DEFAULT_GROUP_VISUAL_WIDTH = 30;
const int DEFAULT_GROUP_VISUAL_HEIGHT = 30;
